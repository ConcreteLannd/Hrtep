...
$re_subject = "資料請求のお申込みありがとうございます。";
...
if(isset($_POST)) {
  $postData = array();
  $postData["企業名"] = $_POST["company_name"];
  $postData["ご担当者名"] = $_POST["name1"] . ' ' . $_POST["name2"];
  $postData["メールアドレス"] = $_POST["email"];
  $postData["電話番号"] = $_POST["phone"];
  $postData["都道府県"] = $_POST["pref"];
  $_POST = $postData;
};
//NULLバイト除去//
...
function mailToAdmin($arr,$subject,$mailFooterDsp,$mailSignature,$encode,$confirmDsp){
	$adminBody="ランディングページより資料請求の申込みがありました。\n";
